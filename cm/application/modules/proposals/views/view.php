...
<div class="block">
                ...
                <form id="form-comment" action="<?php echo site_url('proposals/comment/'.$proposal->proposal_id); ?>" method="post" class="form-horizontal form-bordered" >
