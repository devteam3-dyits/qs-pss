...
<select id="filter_country" name="filter_country" class="form-control input-lg" size="1">
...
<div class="col-md-2">
<form method="post" action="" id="filter_form2" >
<div class="form-group">	

 <select id="filter_option2" name="filter_option2" class="form-control" >
<option value="all" <?php if($filter_option2 == "all") echo ' selected = "selected" '; ?>>All Proposals</option>
<option value="track_only" <?php if($filter_option2 == "track_only") echo ' selected = "selected" '; ?>>My Track</option>
</select>
...
<?php if(trim($search) != ''){?>
<a href="<?php echo site_url('proposals/clear_search'); ?>" class="btn btn-danger"  style="margin-top:15px;width:49%;margin-left:2px" >Clear Search</a>
...
<select type="text" id="select_status" name="select_status" class="form-control"   required>
							 <option value="all" <?php if($select_status == "all") echo ' selected="selected" '; ?> >All Statuses</option>
