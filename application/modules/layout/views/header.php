                   ...
                   <a href="<?php echo base_url(); ?>" class="sidebar-brand" style="text-align:center; padding-top: 10px;">
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
							...
							if($profile_img != '' && file_exists("./uploads/profile_imgs/".$profile_img)){ ?>
                    ...
                    <ul class="sidebar-nav">
                                    ...
                                    <a href="<?php echo site_url('proposals/index'); ?>"><i class="gi gi-file sidebar-nav-icon"></i>Proposals</a>
                                                                ...
                                                                <li>
									<a href="<?php echo site_url('feedback/index'); ?>"><i class="gi gi-chat sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Feedback</span></a>
