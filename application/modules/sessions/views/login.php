...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<!--<style type="text/css">
		body{background : url(<?php echo base_url() ; ?>assets/img/IMG_6986.JPG)}
		</style>
		-->
		<style>
...
<div id="login-background">
    ...
    <img src="<?php echo base_url() ; ?>assets/img/IMG_69864.jpg" alt="Login Background" style="height:auto !important" class="animation-pulseSlow" style="">
</div>
...
<div id="login-container" class="animation-fadeIn" style="top:75px">
    ...
    <div class="login-title text-center">
        ...
        <h1><strong><?php echo lang('header_title'); ?></strong><br><small>Proposer <strong>Login</strong></small></h1>
    </div>
    <!-- END Login Title -->
        ...
        <form action="<?php echo site_url('sessions/login'); ?>" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
            ...
            <div class="form-group">
                <div class="col-xs-12 text-center">
                    ...
                    <a href="<?php echo site_url('sessions/signup'); ?>" ><small>Create a new account</small></a>
                </div>
            </div>
