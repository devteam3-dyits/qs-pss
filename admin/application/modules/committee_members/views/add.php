<div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Add Committee Member</strong> </h2>
                </div>
                ...
                <form id="form-cm" action="<?php echo site_url('committee_members/add'); ?>" method="post" class="form-horizontal form-bordered" >
...
<option value="Zimbabwe">Zimbabwe</option>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="tele" name="tele" class="form-control" placeholder="Enter Telephone" 
							value="" >
