...
<p style="font-size:15px;font-family:Helvetica;color:#606569;padding:0 0 10px;">	
Please note that you can no longer edit your proposal through <a href="http://www.qsglobalevents.com/pss/" >QS Asia Proposal Submission System</a> for <?php echo $event->event_name; ?>,however you could submit a new proposal or if you need to make amendments to this proposal, please write to 
