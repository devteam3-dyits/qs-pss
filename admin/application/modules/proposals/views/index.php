...
<div class="col-md-3">
 <a href="<?php echo site_url('proposals/export_all'); ?>"  data-target="#expallModal2"  class="btn btn-primary " style="margin-top:15px;float:left;margin-left:2px width:49%;">Export to Bizzabo</a>    
 
</div>

<div class="col-md-3">
 <a data-toggle="modal" data-target="#expallModalPI"  class="btn btn-primary " style="margin-top:15px;float:left;margin-left:2px width:49%;">Presenter Info Export</a>    
...
<div class="modal fade" id="expallModalPI" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                 <h4 class="modal-title">Export Prenter Info</h4></div>
            <div class="modal-body">
