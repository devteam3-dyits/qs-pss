...
<div class="block">
                ...
                <form id="form-event" action="<?php echo site_url('events/edit/'.$event->event_id); ?>" method="post" class="form-horizontal form-bordered" >
					...
					<div class="form-group">
                        ...
                        <div class="col-md-9">
							...
							value="<?php echo $event->track_details; ?>" required>
